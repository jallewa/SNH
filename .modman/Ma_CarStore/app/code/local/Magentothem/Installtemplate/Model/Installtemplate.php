...
class Magentothem_Installtemplate_Model_Installtemplate extends Mage_Core_Model_Abstract {
    ...
    public function saveTemplateConfig(int $store) {
        ...
        Mage::getConfig()->saveConfig('design/theme/default', 'ma_carstore', $scope, $store);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'carstore_home', $scope, $store);
		Mage::getConfig()->saveConfig('design/theme/default', 'ma_carstore', 'default', 0);
        Mage::getConfig()->saveConfig('web/default/cms_home_page', 'carstore_home', 'default', 0);
    }
